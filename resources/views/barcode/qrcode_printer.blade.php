    ...
    @for ($i = 0; $i < $entry->count; $i++)
            <div class="barcode-col {{ $i % 2 == 0 ? 'barcode-left' : 'barcode-right' }}">
                ...
                <div class="bar-left" style="margin-right: 10px; margin-top: 6px;">
                    <p class="shoebarsize"><b>Name:</b> {{ $entry->shoe->category->full_name }}-{{ $entry->shoe->color->name }}</p>
                ...
                <div class="bar-right">
                    <img src="data:image/png;base64,{{ DNS2D::getBarcodePNG($entry->shoe->id, 'QRCODE') }}" alt="barcode" style="height:35px;padding-top:22px;">
                </div>
            </div>
            ...
            @for ($i = 0; $i < $entry->count; $i++)
                <div class="barcode-col {{ $i % 2 == 0 ? 'barcode-left' : 'barcode-right' }}">
                    ...
                    <div class="bar-left" style="margin-right: 10px; margin-top: 6px;">
                        ...
                        <p class="shoe-description">
                            <b>size:</b> L <br>
                            <b>দাম:</b> {{ number_format($entry->shoe->retail_price, 2, '.', '') }}<br>
