...
@section('content')
<h1>গিফট মহাজন <small><a href="{{ route('gift-supplier.create') }}" class="btn-new" data-toggle="modal" data-target="#gift-supplier-form">নতুন গিফট মহাজন</a></small></h1>
<table class="table table-striped">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="{{ route('gift-supplier.show', ['gift_supplier' => $giftSupplier->id]) }}">{{ $giftSupplier->name }}</a></td>
