		...
		<div class="col-md-6">
			...
			<table class="table table-striped">
				...
				<tbody>
					<tr>
						<td>মাল</td>
						<td><input type="text" class="form-control text-right input-purchase" value="{{ toFixed($purchase_amount) }}" disabled></td>
					</tr>
					<tr>
						<td>ফেরত (-)</td>
					...
					<tr>
						<td>তাগাদা (-)</td>
						<td><input type="text" class="form-control text-right input-payment" value="{{ toFixed($payment_amount) }}" disabled></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" class="form-control text-right font-weight-bold input-commission-deducted" value="{{ toFixed($total_balance) }}" disabled></td>
					</tr>
					<tr>
						<td>স্টাফ</td>
					...
					<tr>
						...
						<td><input type="text" class="form-control text-right font-weight-bold input-remaining" value="{{ toFixed($total_balance) }}" disabled></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="form-control text-right input-total-cheque" value="{{ toFixed($total_cheque_payment) }}" disabled></td>
					</tr>
					<tr>
						<?php if(!$accountBook->open) $amount -= $accountBook->total_closing_payment; ?>
						<td><strong>বাকী</strong></td>
						<td><input type="text" class="form-control text-right font-weight-bold input-total-remaining" value="{{ toFixed($total_balance) }}" disabled></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table id="closing-cheque-table" class="table table-striped">
				...
				<tfoot>
					<tr>
						...
						<td><input type="text" class="form-control text-right font-weight-bold input-total-cheque" value="{{ toFixed($total_cheque_payment) }}" disabled></td>
					</tr>
				</tfoot>
			</table>
		</div>
