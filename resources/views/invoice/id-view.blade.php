...
<style>
    ...
    {{-- <h1 class="print-top-space">জুতা বিক্রয়ের রশিদ</h1> --}}
    <table class="table table-striped border print-top-space">
        <tbody>
            ...
            <tr>
                <td>
                    নাম: <strong>{{ $invoice->accountBook->retailAccount->name ?? $retailStore->shop_name }}</strong><br>
                ...
                <td>
                    <div class="d-print-none">
                        <a href="{{ route('invoice.show', ['invoice' => $invoice]) }}" class="btn btn-success btn-sm">আইডি
                            ছাড়া দেখুন</a>
                ...
                <tr>
                    <td>
                        @include('templates.thumbnail-preview', [
                            'small_thumbnail' => $invoiceEntry->shoe->image_url,
                            'preview' => $invoiceEntry->shoe->preview_url,
                        ])
                    </td>
