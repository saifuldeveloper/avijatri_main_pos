                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Permission: <span> * </span>
                                            <input type="checkbox" id="permissionAll" style="margin-left: 10px;"> সকল অনুমতি
                                        </label>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-12">
                                            <div class="form-group" style="display: flex; align-items: center; gap:4px;">
                                                <input type="checkbox" name="permissions[]" value="{{ $permission->name }}"
                                                    id="{{ $permission->name }}" @checked(old($permission->name, $role->hasPermissionTo($permission->name)))>
