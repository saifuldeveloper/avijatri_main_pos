        ...
        @if (Auth::check())
            ...
            <div id="nav-menu" class="collapse navbar-collapse">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a href="{{ route('inventory-check.index') }}" class="nav-link">ইনভেন্টরি
                            চেক</a></li>
                    {{-- @endcan --}}
                    {{-- @canany(['manage returns to factory', 'manage returns from retail stores', 'manage pending returns']) --}}
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbar-dropdown-others" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ফেরত</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbar-dropdown-others" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">জোলাপ</a>
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown-others">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbar-dropdown-others" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">খাতা</a>
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown-others">
                    ...
                    {{-- @can('manage reports') --}}
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbar-dropdown-report"
                            role="button" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">রিপোর্ট</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbar-dropdown-others"
                            role="button" data-toggle="dropdown" aria-haspopup="true"
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    {{-- <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbar-dropdown-others"
                            ...
                            সেটিংস</a>
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown-others">
                            <a href="{{ route('setting.users') }}" class="dropdown-item">ব্যবহারকারী</a>
                            <a href="{{ route('setting.permission') }}" class="dropdown-item">অনুমতি দিন</a>
                        </div>
                    </li> --}}

                    <li class="nav-item"><a href="{{ route('password.request') }}" class="nav-link">পাসওয়ার্ড
                            পরিবর্তন</a></li>
