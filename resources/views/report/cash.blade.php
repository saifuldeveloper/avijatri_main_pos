...
<form action="{{ route('report.cash') }}" method="get" class="form-inline mb-3">
	...
	<input type="date" name="from" id="cash-from" class="form-control mx-3" required>
	<label for="cash-from">শেষ তারিখ</label>
	<input type="date" name="to" id="cash-to" class="form-control mx-3" required>
